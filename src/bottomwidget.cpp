...
//    }
    for (QPushButton *btn : m_btnList) {
        ...
        connect(btn, &QPushButton::clicked, this, &BottomWidget::onButtonClicked);
    }
...
void BottomWidget::onButtonClicked()
{
...
bool BottomWidget::eventFilter(QObject *watched, QEvent *event)
{
